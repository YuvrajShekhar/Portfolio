...
export const EXPERIENCES = [
  ...
  },
  {
    ...
    company: "Subex",
    description: {
      p1 : `Cybersecurity Development: Develop and enhance cybersecurity products, addressing evolving threats and security requirements.`,
      p2 : `Design and Architecture: Create detailed technical designs, including high-level, low-level, and database architectures, collaborating with product managers and developers.`,
      p3 : `Full-Stack Development: Build and maintain full-stack web applications for internal and external use, including APIs and integration solutions.`,
      p4 : `Coding and Testing: Write clean, efficient code following best practices, conducting unit and integration testing to ensure quality and performance.`,
      p5 : `Version Control & Documentation: Use version control systems like Git for collaboration and maintain comprehensive technical documentation for workflows and codebases.`,
      p6 : `Automation & Debugging: Automate tasks across system functionalities, and identify and resolve bugs or performance issues to optimize processes.`,
    } ,

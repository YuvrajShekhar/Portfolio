...
export const EXPERIENCES = [
  {
    ...
    description: {
      p1: `Advanced analytics development: Created a full sales analytics dashboard using Chart.js with multi-dimensional KPIs, profitability scoring, and predictive call-center performance modeling. Built interactive visualizations from CSV inputs, enabling real-time insights, anomaly detection, and scenario planning across 25+ chart types and 7 analytical views.`,
      p2: `Landing page engineering: Built a responsive React landing page using Tailwind CSS with dynamic content sections and optimized loading performance. Integrated modern tooling and deployed through a CI/CD pipeline for automated testing and seamless updates.`,
      p3: `Real-estate visualization platform: Developed a full-stack property discovery tool using React, Leaflet Maps, and Tailwind CSS. Implemented custom map markers, modular UI components, real-time interactions, dynamic filters, and a polished glassmorphism-based dark theme for the Berlin rental market.`,
      p4 : `Document automation system: Created a full-stack automation workflow using React and FastAPI to generate Word documents from Jinja2 templates. Added automated form generation, placeholder extraction, and DOCX validation to ensure consistent and error-free output.`,
    },
